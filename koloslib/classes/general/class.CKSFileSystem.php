<?php
/**
 * Класс выполняет работу, со стандартной файловой системой. Является оберткой для функций пхп связанных с работой с СФ.
 * @version 2.6
 * @since 17.10.2008
...
class CKSFileSystem {
	/**
	 * Функция makedir создает указанную папки или весь путь. В зависимости от существования на диске указанного пути
	 * происходит создание папок.Если каталог создать не удалось выбрасывает исключение CFileRror
